...
class FieldMetadataServiceTest {
  ...
  void load() {
    ...
    when(vcfHeader.getInfoHeaderLines())
        .thenReturn(Set.of(csqInfoHeaderLine, testinfoHeaderLine, test3infoHeaderLine));
    when(vcfHeader.getFormatHeaderLines())
        .thenReturn(Set.of(formatHeaderLine1, formatHeaderLine2, formatNestedHeaderLine));

    NestedFieldMetadata nestedVippMeta =
    ...
    NestedFieldMetadata nestedTestMeta =
        NestedFieldMetadata.builder()
            ...
            .build();
    NestedFieldMetadata nestedTest2Meta =
        NestedFieldMetadata.builder()
            .index(2)
            .label("TEST2")
            .type(ValueType.STRING)
            .numberType(ValueCount.Type.FIXED)
            .numberCount(1)
            .build();
    FieldMetadata csqMeta =
        FieldMetadata.builder()
            .nestedAttributes(new NestedAttributes("TEST:", "|"))
            .label("VEP")
            .description("TEST:VIPP|TEST|TEST2")
            .numberType(ValueCount.Type.VARIABLE)
            .type(ValueType.STRING)
            .numberType(ValueCount.Type.VARIABLE)
            .nestedFields(
                Map.of("VIPP", nestedVippMeta, "TEST", nestedTestMeta, "TEST2", nestedTest2Meta))
            .build();
    FieldMetadata testMeta =
        FieldMetadata.builder()
            .label("TEST INFO")
            ...
            .numberCount(1)
            .build();
    FieldMetadata test3Meta =
        FieldMetadata.builder()
            .label("TEST3")
            .type(ValueType.FLOAT)
            .numberType(ValueCount.Type.R)
            .build();
    FieldMetadata format1Meta =
        FieldMetadata.builder()
            .label("TEST")
            .description("TEST")
            .type(ValueType.INTEGER)
            ...
            .numberCount(1)
            .build();
    FieldMetadata format2Meta =
        FieldMetadata.builder()
            .label("FORMAT2")
            .type(ValueType.FLOAT)
            .numberType(ValueCount.Type.A)
            .build();
    NestedFieldMetadata formatNestedTest =
        NestedFieldMetadata.builder()
            .label("NESTED label")
            ...
            .index(0)
            .build();
    FieldMetadata formatNestedMeta =
        FieldMetadata.builder()
            .label("NESTED_FORMAT")
            .description("NESTED_FORMAT:TEST")
            .type(ValueType.STRING)
            .numberType(ValueCount.Type.R)
            .nestedFields(Map.of("TEST", formatNestedTest))
            .nestedAttributes(new NestedAttributes("NESTED_FORMAT:", "|"))
            .build();

    FieldMetadatas expected =
        FieldMetadatas.builder()
            .info(Map.of("CSQ", csqMeta, "TEST", testMeta, "TEST3", test3Meta))
            .format(
                Map.of(
                    "FORMAT1",
                    format1Meta,
  ...
  void loadNoPrefix() {
    ...
    FieldMetadatas expected =
        FieldMetadatas.builder()
            .info(Map.of("CSQ", csqMeta, "TEST", testMeta, "TEST3", test3Meta))
            .format(Map.of("FORMAT1", format1Meta))
            .build();
