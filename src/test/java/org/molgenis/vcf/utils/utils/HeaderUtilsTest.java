...
class HeaderUtilsTest {
  ...
  void fixVcfFormatHeaderLines() {
    when(vcfHeader.getFormatHeaderLines())
        .thenReturn(
            Set.of(new VCFFormatHeaderLine("test", 1, VCFHeaderLineType.String, "\"desc\"")));
    Set<VCFFormatHeaderLine> expected =
        Set.of(new VCFFormatHeaderLine("test", 1, VCFHeaderLineType.String, "\\\"desc\""));
        ...
        .thenReturn(
            Set.of(
                new VCFFormatHeaderLine(
                    "test", VCFHeaderLineCount.A, VCFHeaderLineType.String, "\"desc\"")));
    Set<VCFFormatHeaderLine> expected =
        Set.of(
            new VCFFormatHeaderLine(
                "test", VCFHeaderLineCount.A, VCFHeaderLineType.String, "\\\"desc\""));
  ...
  void fixVcfInfoHeaderLines() {
    when(vcfHeader.getInfoHeaderLines())
        .thenReturn(Set.of(new VCFInfoHeaderLine("test", 1, VCFHeaderLineType.String, "\"desc\"")));
    Set<VCFInfoHeaderLine> expected =
        Set.of(new VCFInfoHeaderLine("test", 1, VCFHeaderLineType.String, "\\\"desc\""));
  ...
  void fixVcfFilterHeaderLines() {
    when(vcfHeader.getFilterLines())
        .thenReturn(List.of(new VCFFilterHeaderLine("test", "\"desc\"")));
